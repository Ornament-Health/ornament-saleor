...
SUBSCRIPTION_VAUCHER_DEFAULT = os.environ.get("SUBSCRIPTION_VAUCHER_DEFAULT", None)
SUBSCRIPTION_VAUCHER_ANNUAL = os.environ.get(
    "SUBSCRIPTION_VAUCHER_ANNUAL", SUBSCRIPTION_VAUCHER_DEFAULT
)
SUBSCRIPTION_VAUCHER_MONTHLY = os.environ.get(
    "SUBSCRIPTION_VAUCHER_MONTHLY", SUBSCRIPTION_VAUCHER_DEFAULT
)
SUBSCRIPTION_VAUCHER_PROMO = os.environ.get(
    "SUBSCRIPTION_VAUCHER_PROMO", SUBSCRIPTION_VAUCHER_DEFAULT
)
SUBSCRIPTION_VAUCHER_THREE_MONTH = os.environ.get(
    "SUBSCRIPTION_VAUCHER_THREE_MONTH", SUBSCRIPTION_VAUCHER_DEFAULT
)
SUBSCRIPTION_VAUCHER_UNKNOWN = os.environ.get(
    "SUBSCRIPTION_VAUCHER_UNKNOWN", SUBSCRIPTION_VAUCHER_DEFAULT
)
